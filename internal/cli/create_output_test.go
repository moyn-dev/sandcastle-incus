...
func TestFormatCreateMachineV2Golden(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			want: "Machine acme@obelix:plain:web created (container, image images:debian/13/cloud).\n" +
		...
		},
		{
			...
			want: "Machine acme@obelix:default:web created (container, image images:debian/13/cloud).\n" +
				"Storage: shared /workspace, machine-local /home (add --home-share for a shared /home).\n" +
		...
		},
		{
			...
			want: "Machine acme@obelix:plain:web would be created (container, image images:debian/13/cloud).\n" +
				"Storage: shared /workspace, machine-local /home (add --home-share for a shared /home).\n" +
		...
		},
		{
			...
			want: "Machine acme@obelix:zp:web created (container, image images:debian/13/cloud).\n" +
				"Storage: shared /workspace, machine-local /home (add --home-share for a shared /home).\n" +
				"IP: 10.249.7.9\n" +
		...
		},
		{
			...
			want: "Machine acme@obelix:default:web would be created (container, image images:debian/13/cloud).\n" +
				"Storage: shared /workspace, machine-local /home (add --home-share for a shared /home).\n" +
				"DNS: web.default.acme (also: web.acme) (auto-registers after boot)\n" +
		...
		},
		{
			...
			want: "Machine acme@obelix:zp:web would be created (container, image images:debian/13/cloud).\n" +
				"Storage: shared /workspace, machine-local /home (add --home-share for a shared /home).\n" +
				"DNS: web.zp.acme (auto-registers after boot)\n" +
				"Public name: web.baum.hase.de (A record pending, certificate pending — see: sc project status zp)\n" +
